...
public class OnLockService extends Service {
    ...
    public static class OnLockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // an Intent broadcast.
            ExceptionLogHelper elh = new ExceptionLogHelper(context.getApplicationContext());
            ...
            if (current != null) {
                while (true) {
                    try {
                        ...
                        ExceptionModel em = new ExceptionModel(e.getMessage(), Arrays.toString(e.getStackTrace()), new Date().toString(), "OnLockService.onReceive");
                        elh.insert(em);
                    } finally {
                        dbHelper.updateCurrent(current, false);
